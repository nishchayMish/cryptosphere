...
const Signup = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4'>
      <div className='w-full max-w-[400px] min-h-[500px] bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-lg'>
        ...
        <form className='mt-6' onSubmit={handleSubmit}>
          <div className='mb-4'>
            ...
            <div className='relative mt-2'>
              ...
              />
              <AiOutlineUser className='absolute left-3 top-4 text-gray-400 dark:text-gray-300 text-lg' />
            </div>
          </div>
          <div className='mb-4'>
        ...
        <p className='text-center text-gray-600 dark:text-gray-300 mt-4'>
          Already have an account? <Link className='text-indigo-600 dark:text-indigo-400 font-medium hover:underline' to='/signin'>Sign In</Link>
        </p>
      </div>
    </div>
  );
